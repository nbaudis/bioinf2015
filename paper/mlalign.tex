...
devise the memory layout for the three DP matrices {\bf TODO (Daniel) DPMs?} ($M_0,M_1,M_2$).  
...
index $y$ {\bf TODO (Daneil) Is it correct to repeat the $y$ at the end of the sentence? I would also insert another verb as "denotes" ...and the superscript $y$ denotes the SS3/AVX...}.  The first row of the Figure depicts the {\em AoS} data layout. 
...
When {\bf TODO (Daniel) Remove this When?} vectorizing along the anti-diagonals, accessing the memory in the DPMs when they are stored in row-, or column-major order

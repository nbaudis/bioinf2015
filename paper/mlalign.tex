...
%index $y$ {\bf TODO (Daneil) Is it correct to repeat the $y$ at the end of the sentence? I would also insert another verb as "denotes" ...and the superscript $y$ denotes the SS3/AVX...}. 
...
From each of the six MSAs, we picked ten sequences {\bf at random or how did
you pick them???} and recomputed all possible 45 pairwise alignments between
each set of ten sequences. 
